...
public class ConfigProvider extends YamlConfiguration {
    ...
    public ConfigProvider(String path) throws IOException, InvalidConfigurationException {
        this(path, false);
    }
    ...
    public static Boolean getBoolean(String path, Boolean def, String pluginName) throws IOException, InvalidConfigurationException {
        return getBoolean(path, def, new File("./plugins/" + pluginName + "/config.yml"));
    }

    public static Boolean getBoolean(String path, Boolean def, File file) throws IOException, InvalidConfigurationException {
        YamlConfiguration config = new YamlConfiguration();
        config.load(file);
        return config.getBoolean(path, def);
    }

    public static String getString(String path, String def, String pluginName) throws IOException, InvalidConfigurationException {
        return getString(path, def, new File("./plugins/" + pluginName + "/config.yml"));
    }

    public static String getString(String path, String def, File file) throws IOException, InvalidConfigurationException {
        YamlConfiguration config = new YamlConfiguration();
        config.load(file);
